...
If your are running **Windows**, it is possible that you don't have the latest version of WSL (Windows Subsystem for Linux) that is required by Docker. Run the following command in an elevated PowerShell window, to ensure you have the latest version of WSL.
